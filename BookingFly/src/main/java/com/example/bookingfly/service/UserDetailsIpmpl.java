...
public class UserDetailsIpmpl implements UserDetails {
    ...
    public static com.example.bookingfly.service.UserDetailsIpmpl build(User user) {
        List<GrantedAuthority> authorities = user.getRoles().stream()
                .map(role -> new SimpleGrantedAuthority(role.getName().name()))
                .collect(Collectors.toList());

        return new com.example.bookingfly.service.UserDetailsIpmpl(
                user.getId(),
                user.getAvt(),
                user.getFirstName(),
                user.getLastName(),
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || getClass() != o.getClass())
            return false;
        com.example.bookingfly.service.UserDetailsIpmpl user = (com.example.bookingfly.service.UserDetailsIpmpl) o;
