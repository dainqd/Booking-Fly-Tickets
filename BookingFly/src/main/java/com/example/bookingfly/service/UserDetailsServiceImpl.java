...
import com.example.bookingfly.dto.request.ForgotPasswordRequest;
import com.example.bookingfly.dto.request.SignupRequest;
...
import static com.example.bookingfly.restapi.AuthApi.MESS_ERR_ROLE;
import static com.example.bookingfly.util.Utils.*;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public User create(SignupRequest request, String verifyCode) {
        ...
        user.setStatus(Enums.AccountStatus.INACTIVE);
